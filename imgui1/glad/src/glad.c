/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.30 on Thu Jun 20 16:36:38 2019.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=4.0, gles2=3.2, gles1=1.0
    Profile: core
    Extensions:
        GL_ARB_debug_output,
    ...
    Commandline:
        --profile="core" --api="gl=4.0,gles2=3.2,gles1=1.0" --generator="c" --spec="gl" --extensions="GL_ARB_debug_output,GL_ARB_framebuffer_sRGB,GL_ARB_multisample,GL_EXT_texture_sRGB"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.0&api=gles2%3D3.2&api=gles1%3D1.0&extensions=GL_ARB_debug_output&extensions=GL_ARB_framebuffer_sRGB&extensions=GL_ARB_multisample&extensions=GL_EXT_texture_sRGB
*/

#ifdef USING_SDL
#include "SDL_stdinc.h"
#define String_scanf SDL_sscanf
...
#else
#if !defined(String_cstrlen) || !defined(String_vsnprintf)
#ifndef NO_STD
// using std
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#else
#error required implementation, see above
#endif
#endif
#endif
...
/* PR #18 */
#ifdef USING_SDL
	SDL_sscanf(version, "%d.%d", &major, &minor);
#else
#ifdef _MSC_VER
