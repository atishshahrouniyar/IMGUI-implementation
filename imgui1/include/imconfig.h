...
//---- Define constructor and implicit cast operators to convert back<>forth between your math types and Vector2/ImVec4.
// This will be inlined as part of Vector2 and ImVec4 class declarations.
/*
#define IM_VEC2_CLASS_EXTRA                                                 \
        Vector2(const MyVec2& f) { x = f.x; y = f.y; }                       \
